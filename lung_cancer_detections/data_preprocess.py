...
for patient in patients[:target]:
    try: # 有些 patient 沒有在labels.df
        ...
        print(slices[0]) # slices包含一個patient所有片段的images資訊，我們現在把一個拿出來看
    except:
        pass
...
############################### 階段2. 將圖片前處理包成function，並且儲存成 每個patient CT scan 為 50*50*20 .npy檔案
...
################################# 階段3. 讀取上一步驟儲存的 .npy 檔案，進行CNN modeling
